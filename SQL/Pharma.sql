...
(1, 'ushasri.le.21.cse@anits.edu.in', 'Usha Sri', 'Sabbavarapu', 'admin'),
(2, 'maradajoshith.20.cse@anits.edu.in', 'Joshith', 'Marada', 'admin'),
(3, 'lalithkiran7@gmail.com', 'Lalith', 'Peerukattla', 'admin'),
(4, 'karthikeya@gmail.com', 'Karthikeya', 'Panangipalli', 'admin');
